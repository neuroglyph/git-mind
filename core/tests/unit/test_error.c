...
static void test_error_chain(void) {
    gm_error_t *cause =
        gm_error_new(GM_ERR_FILE_NOT_FOUND, "config.toml not found");
    gm_error_t *err =
...
static void test_error_sso(void) {
    ...
    const char *large_msg = "This is a very long error message that exceeds "
                            "the small string optimization "
                            "threshold and should be allocated on the heap "
