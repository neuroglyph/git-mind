...
static int validate_link_inputs(gm_context_t *ctx, const char *type_str, 
                               const char *confidence_str, gm_rel_type_t *rel_type, 
                               uint16_t *confidence, gm_attribution_t *attribution) {
    int result;
...
static void print_link_success(gm_context_t *ctx, const gm_edge_attributed_t *edge,
