...
- **SHA**: Immutable content reference
- **Path**: Human-understandable context
- **Both**: Can track evolution over time
...
2. **Extensible**: CBOR allows growth
3. **Efficient**: Stack-friendly size
4. **Clear**: Each field has one purpose
5. **Git-native**: SHAs are Git's language
