...
- Ref utils hardening:
  ...
  - Refreshed `docs/architecture/Ref_Name_Validation.md`, documented guardrails in README/CLI guides, and logged the clang-tidy backlog snapshot (`docs/quality/Clang_Tidy_Backlog_2025-09-29.md`); Features Ledger now shows GM.MVP.T002 at 100%.
- Post-merge wrap-up:
